/* 
 * File: i2c_bmp180.c
 * Description: Driver for the BMP180 i2c air pressure sensor
 * Author: reaper7
 */
...
int16_t ICACHE_FLASH_ATTR BMP180_readRawValue(uint8_t cmd)
{
  ...
  //os_printf("BMP180_READRAW_OK\r\n");
  return res;
}

int32_t ICACHE_FLASH_ATTR BMP180_GetVal(uint8_t mode)
{
  //os_printf("BMP180_GETVAL (START)\r\n");
  int32_t UT;
  uint16_t UP;
  int32_t B3, B5, B6;
  uint32_t B4, B7;
